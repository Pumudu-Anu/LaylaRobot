...
STICKERS = (
    "CAACAgUAAx0CSUIogQACA75g8pWTK70pYkB4U_vIE1WSCpjn0QAChwMAAh9zkFfwPKuXO1RrLyAE"
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/Kumikosetsukobot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/TheKumikoSetsuko"),
        InlineKeyboardButton(
            text="ꜰᴇᴅᴇʀᴀᴛɪᴏɴ", url=f"https://t.me/TheKumikoSetsuko"
        ),
    ],
    [
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Kumiko](https://t.me/KumikoSetsuko) \
 Supporting isnt always financial! [AwesomeSupport](https://t.me/KumikoSetsuko) \
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Kumiko Setsuko*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Awesome Bots @KumikoSetsuko
                 \n❍ Support Group @KumikoSetsuko
                 \n❍ Assistant @KumikoSetsuko.
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yes I'm with you 😊")
        except Unauthorized:
            LOGGER.warning(
